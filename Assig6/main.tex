...
\begin{abstract}
This document contains the solution for Assignment 6 (NCERT Class 12 Example 29)
\end{abstract}
%template ends here
\begin{enumerate}
\item[\textbf{(29)}]Two cards are drawn simultaneously (or successively without replacement) from a well shuffled pack of 52 cards. Find the mean, variance and standard deviation of the number of kings.
\solution
...
\begin{figure}
    \centering
    \includegraphics[width = 0.45\textwidth]{figures/plot}
    \caption{PMF Of $X$}
    \label{fig:figure1}
\end{figure}
\end{enumerate}
