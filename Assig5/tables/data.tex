...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	 ...
	 \gnumericPB{\raggedright}\gnumbox[l]{\textbf{S.No.}}
	&\gnumericPB{\raggedright}\gnumbox[l]{\textbf{Name}}
	&\gnumericPB{\raggedright}\gnumbox[l]{\textbf{Sex}}
	&\gnumericPB{\raggedright}\gnumbox[l]{\textbf{Age in years}}
	&
\\
	 \gnumericPB{\raggedleft}\gnumbox[r]{1}
	&\gnumericPB{\raggedright}\gnumbox[l]{Harish}
	&\gnumericPB{\raggedright}\gnumbox[l]{M}
	&\gnumericPB{\raggedleft}\gnumbox[r]{30}
	&
\\
	 \gnumericPB{\raggedleft}\gnumbox[r]{2}
	&\gnumericPB{\raggedright}\gnumbox[l]{Rohan}
	&\gnumericPB{\raggedright}\gnumbox[l]{M}
	&\gnumericPB{\raggedleft}\gnumbox[r]{33}
	&
\\
	 \gnumericPB{\raggedleft}\gnumbox[r]{3}
	&\gnumericPB{\raggedright}\gnumbox[l]{Sheetal}
	&\gnumericPB{\raggedright}\gnumbox[l]{F}
	&\gnumericPB{\raggedleft}\gnumbox[r]{46}
	&
\\
	 \gnumericPB{\raggedleft}\gnumbox[r]{4}
	&\gnumericPB{\raggedright}\gnumbox[l]{Alis}
	&\gnumericPB{\raggedright}\gnumbox[l]{F}
	&\gnumericPB{\raggedleft}\gnumbox[r]{28}
	&
\\
	 \gnumericPB{\raggedleft}\gnumbox[r]{5}
	&\gnumericPB{\raggedright}\gnumbox[l]{Salim}
	&\gnumericPB{\raggedright}\gnumbox[l]{M}
